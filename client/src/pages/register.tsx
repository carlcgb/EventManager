    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-white/60 backdrop-blur-sm border-amber-200 shadow-xl">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-bold text-amber-800">Rejoindre la plateforme</CardTitle>
          <CardDescription className="text-amber-600">
            Utilisez Google pour commencer à gérer vos événements
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          {/* Google Sign In - Primary registration method */}
          <Button
            type="button"
          ...
          <div className="text-center text-sm text-amber-700 bg-amber-50 p-4 rounded-lg border border-amber-200">
            <p className="font-medium">Inscription sécurisée avec Google</p>
            <p className="text-amber-600 mt-1">
              Votre compte sera automatiquement créé lors de votre première connexion
            </p>
          </div>
